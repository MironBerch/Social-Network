...
class AuthenticateTestCase(TestCase):
    ...
    def test_authenticate_with_email(self):
        ...
        """
        a = authenticate(login="email@gmail.com", password="password")
    ...
    def test_authenticate_with_username(self):
        ...
        """
        a = authenticate(login="username", password="password")
        self.assertIsNotNone(a)
    ...
    def test_authenticate_with_email_with_caps(self):
        ...
        """
        a = authenticate(login="JIM@TESTING.COM", password="password")
        self.assertIsNotNone(a)
